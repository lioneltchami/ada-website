...
async function seed() {
  ...
  await client.createOrReplace({
    ...
    tagline:
      "Empowering vulnerable communities in Cameroon through faith-based programs supporting widows, orphans, and young women since 2021.",
  ...
  const roles = [
    {
      ...
      description: "Lead community engagement and program delivery.",
    ...
    },
    {
      ...
      description:
        "Tutor and mentor orphaned children in our education program.",
    ...
    },
    {
      ...
      description: "Teach vocational skills to young women.",
    ...
    },
    {
      ...
      description:
        "Assist with hospital visits and health awareness campaigns.",
    ...
    },
    {
      ...
      description: "Manage social media, create content, and tell our story.",
      timeCommitment: "5-10 hrs/week",
      location: "Remote",
      sortOrder: 5,
    },
    {
      _id: "role-fundraising",
      title: "Fundraising & Events",
      description: "Help plan campaigns and coordinate fundraising events.",
  ...
  const tiers = [
    {
      _id: "tier-25",
      amount: 25,
      impactDescription: "School supplies for 2 children",
      sortOrder: 1,
    },
    {
      _id: "tier-50",
      amount: 50,
      impactDescription: "Widow support for a week",
      sortOrder: 2,
    },
    {
      _id: "tier-100",
      amount: 100,
      impactDescription: "Skills training for one woman",
      sortOrder: 3,
    },
    {
      _id: "tier-250",
      amount: 250,
      impactDescription: "Healthcare for 5 families",
      sortOrder: 4,
    },
    {
      _id: "tier-500",
      amount: 500,
      impactDescription: "Agricultural training for 3 farmers",
      sortOrder: 5,
    },
    {
      _id: "tier-1000",
      amount: 1000,
      impactDescription: "Community clean-up initiative",
      sortOrder: 6,
    },
  ];
